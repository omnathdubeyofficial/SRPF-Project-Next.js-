          ...
          <div className="col-lg-8">
           ...
           <img src="assets/img/blog/blog-1.jpg" alt="" className="img-fluid"/>
              ...
              <div className="meta-top">
                <ul>
                  <li className="d-flex align-items-center"><i className="bi bi-person"></i> <a href="blog-details.html">Omnath Dubey</a></li>
                  <li className="d-flex align-items-center"><i className="bi bi-clock"></i> <a href="blog-details.html"><time>Jan 1, 2023</time></a></li>
